...
struct GraphView: View {
    ...
    var body: some View {
        ...
        .onChange(of: timeFrame, perform: { value in
            setValues()
        })
        .onChange(of: temperatureAggregationsVM.minimumsDay , perform: { value in
            setValues()
        })
        .onChange(of: temperatureAggregationsVM.minimumsWeek , perform: { value in
            setValues()
        })
        .onChange(of: temperatureAggregationsVM.minimumsMonth , perform: { value in
            setValues()
        })
        .onChange(of: zoomed, perform: { value in
            setMinMax()
        })
